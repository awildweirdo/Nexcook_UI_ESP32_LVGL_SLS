...
void ui_Recipe_Selection_screen_init(void)
{
    ...
    ui_Image4 = lv_img_create(ui_Recipe_Selection);
    lv_img_set_src(ui_Image4, &ui_img_vitxmitatronics_png);
    lv_obj_set_width(ui_Image4, LV_SIZE_CONTENT);   /// 512
    lv_obj_set_height(ui_Image4, LV_SIZE_CONTENT);    /// 512
    lv_obj_set_x(ui_Image4, 7);
    lv_obj_set_y(ui_Image4, -182);
    ...
    lv_obj_set_style_text_color(ui_Label6, lv_color_hex(0xE65062), LV_PART_MAIN | LV_STATE_DEFAULT);
